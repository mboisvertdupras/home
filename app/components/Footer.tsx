    ...
    <div className="mx-auto max-w-3xl">
      ...
      <footer className="flex items-center justify-end">
        <ul className="flex space-x-4 text-sage-400">
          <li>
            <a
              href="https://github.com/mboisvertdupras"
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/marc-boisvert-dupras-22a98760/"
              className="transition-colors hover:text-sage-600"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/marcbd_/"
              className="transition-colors hover:text-sage-600"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <li>
            <a
              href="mailto:marcboisvert.dupras@outlook.com"
              className="transition-colors hover:text-sage-600"
            >
              <svg className="h-6 w-6" viewBox="0 0 15 15">
                <path
